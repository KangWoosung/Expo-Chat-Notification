  ...
  theme: {
    extend: {
      colors: {
        ...
        // 액센트 컬러 (Gold 계열 - 우아하고 고급스러운 골드)
        accent: {
          50: "hsl(48, 100%, 96%)", // 가장 밝은 액센트 (크림 골드)
          100: "hsl(48, 100%, 88%)", // 매우 밝은 액센트 (라이트 골드)
          200: "hsl(45, 93%, 76%)", // 밝은 액센트 (소프트 골드)
          300: "hsl(45, 86%, 62%)", // 중간 밝은 액센트 (미디엄 골드)
          400: "hsl(43, 89%, 38%)", // 중간 액센트 (리치 골드)
          500: "hsl(41, 96%, 40%)", // 기본 액센트 (클래식 골드)
          600: "hsl(36, 77%, 49%)", // 중간 어두운 액센트 (딥 골드)
          700: "hsl(32, 81%, 36%)", // 어두운 액센트 (브론즈 골드)
          800: "hsl(28, 84%, 30%)", // 매우 어두운 액센트 (다크 브론즈)
          900: "hsl(24, 87%, 24%)", // 가장 어두운 액센트 (앤틱 브론즈)
          950: "hsl(20, 90%, 15%)", // 거의 검은 액센트 (블랙 브론즈)
        },
        ...
        // 버튼 색상 (Primary 및 Secondary) - Gold 계열로 업데이트
        primary: {
          DEFAULT: "hsl(41, 96%, 40%)", // 브랜드 컬러 (클래식 골드 - accent-500)
          dark: "hsl(43, 89%, 38%)", // 다크 모드 브랜드 컬러 (리치 골드 - accent-400)
          hover: "hsl(36, 77%, 49%)", // 호버 상태 (딥 골드 - accent-600)
          hoverDark: "hsl(41, 96%, 40%)", // 다크 모드 호버 상태 (클래식 골드 - accent-500)
          active: "hsl(32, 81%, 36%)", // 활성 상태 (브론즈 골드 - accent-700)
          activeDark: "hsl(36, 77%, 49%)", // 다크 모드 활성 상태 (딥 골드 - accent-600)
        ...
        // 정보 색상 - Gold 계열로 업데이트
        info: {
          DEFAULT: "hsl(41, 96%, 40%)", // 정보 컬러 (클래식 골드 - accent-500)
          dark: "hsl(43, 89%, 38%)", // 다크 모드 정보 컬러 (리치 골드 - accent-400)
          hover: "hsl(36, 77%, 49%)", // 호버 상태 (딥 골드 - accent-600)
          hoverDark: "hsl(41, 96%, 40%)", // 다크 모드 호버 상태 (클래식 골드 - accent-500)
          active: "hsl(32, 81%, 36%)", // 활성 상태 (브론즈 골드 - accent-700)
          activeDark: "hsl(36, 77%, 49%)", // 다크 모드 활성 상태 (딥 골드 - accent-600)
        ...
        input: {
          ...
          dark: "hsl(216, 4.70%, 21.00%)", // 다크 모드 입력 배경 (gray-900)
          border: "hsl(210, 20%, 82%)", // 라이트 모드 입력 테두리 (gray-300)
          borderDark: "hsl(216, 4.70%, 21.00%)", // 다크 모드 입력 테두리 (gray-800)
          focus: "hsl(41, 96%, 40%)", // 포커스 테두리 (클래식 골드 - accent-500)
          focusDark: "hsl(43, 89%, 38%)", // 다크 모드 포커스 테두리 (리치 골드 - accent-400)
        },

        card: {
          DEFAULT: "hsl(0, 0%, 100%)", // 라이트 모드 카드 배경 (흰색)
          dark: "hsl(216, 4.70%, 21.00%)", // 다크 모드 카드 배경 (gray-900)
        },
        ...
        muted: {
          ...
          dark: "hsl(216, 4.70%, 21.00%)", // 다크 모드 뮤티드 배경 (gray-800)
          foreground: "hsl(210, 20%, 45%)", // 라이트 모드 뮤티드 전경 (gray-600)
          foregroundDark: "hsl(210, 20%, 70%)", // 다크 모드 뮤티드 전경 (gray-400)
        },

        ring: {
          DEFAULT: "hsl(41, 96%, 40%)", // 포커스 링 (클래식 골드 - accent-500)
          dark: "hsl(43, 89%, 38%)", // 다크 모드 포커스 링 (리치 골드 - accent-400)
        },
      },
      fontFamily: {
